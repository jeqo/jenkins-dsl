freeStyleJob('update_fork_confluent_common') {
    displayName('update-fork-confluent-common')
    description('Rebase the primary branch (master) in jeqo/confluent-common fork.')
    ...
    scm {
        git {
            remote {
                url('git@github.com:jeqo/confluent-common.git')
                name('origin')
