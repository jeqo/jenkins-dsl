freeStyleJob('update_fork_confluent_rest_utils') {
    displayName('update-fork-confluent-rest-utils')
    description('Rebase the primary branch (master) in jeqo/confluent-rest-utils fork.')
    ...
    scm {
        git {
            remote {
                url('git@github.com:jeqo/confluent-rest-utils.git')
                name('origin')
